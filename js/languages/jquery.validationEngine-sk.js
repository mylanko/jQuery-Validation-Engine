    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"groupRequired": {
                    "regex": "none",
                    "alertText": "* Musíte zadať jedno z nasledujúcích polí"
                },
                "min": {
                    "regex": "none",
                ...
                "SKphone": {
                    ...
                    "alertText": "* Neplatné telefónne číslo, zadajte vo formáte +421 555-598-895"
                },
                "phone": {
                ...
                //slovenská syntax pre rodné číslo
                "rc": {
                    "regex": /^\d{2}((0[1-9]|1[012])|(5[1-9]|6[012]))(0[1-9]|[12][0-9]|3[01])\/([0-9]{2,4})$/,
                    "alertText": "* Neplatné rodné číslo, tvar musí byť 840708/1234"
                },
                //poštové smerovacie číslo
                "psc": {
                    "regex": /^\d{3}[ \.\-]\d{2}$/,
                    "alertText": "* Neplatné poštové smerovacie číslo, tvar musí byť 831 07"
                },
                "url": {
                ...
                "ajaxUserCall": {
                    ...
                    "extraData": "name=eric",
                    "alertText": "* Používateľské meno sa už používa",
